...
We as members, contributors, and admins of **ReadmeForge** pledge to make
...
- Helping and supporting fellow contributors, especially first-timers
...
Project admins are responsible for clarifying and enforcing our standards of
acceptable behavior and will take appropriate and fair corrective action in
response to any behavior that they deem inappropriate, threatening, offensive,
or harmful.

Project admins have the right and responsibility to remove, edit, or reject
...
repository, issues, pull requests, discussions, and any other official
ReadmeForge communication channels.

It also applies when an individual is officially representing the project in
public spaces, such as using an official project email address, posting via an
...
reported to the project admin at:

📧 **berwaliamohit@gmail.com**

All complaints will be reviewed and investigated promptly and fairly.
The project admin is obligated to maintain confidentiality with regard
...
Project admins will follow these guidelines in determining the consequences
...
*ReadmeForge is built with ❤️ — let's keep it a welcoming space for everyone.*
